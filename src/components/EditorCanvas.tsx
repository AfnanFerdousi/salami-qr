          ...
          elements.forEach(el => {
            if (el instanceof HTMLElement) {
              ...
              if (computedStyle.position === 'absolute') {
                ...
                el.style.zIndex = computedStyle.zIndex;
    ...
    <div className="w-full flex flex-col items-center">
      <div className="mb-6 w-full max-w-md">
        ...
        >
          ...
          <div className="absolute top-0 left-0 right-0 p-4 text-center">
            <div className="flex items-center justify-center mb-2">
              <div className="bg-white px-5 py-2 rounded-full shadow-md border border-eid-gold/30">
                <img 
                  src="/lovable-uploads/2a98657a-47ed-43f6-a605-5d1874176625.png" 
                  alt="bKash Logo" 
          ...
          {qrCodeImage && (
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-56 h-56 bg-white p-3 rounded-lg shadow-lg border-2 border-bkash flex items-center justify-center">
              <img
                src={qrCodeImage}
                alt="QR Code"
